...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: login_input_1.LoginInput }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Login successful, returns user and access token' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'User registration', description: 'Register a new user account' }),

...
let UsersService = class UsersService {
    ...
    async create(input) {
        ...
        return user_dto_1.UserDto.fromEntity(saved);
    }
    async findAll() {
        const users = await this.usersRepo.find();
        return users.map(user_dto_1.UserDto.fromEntity);
    }
    async findOne(id) {
    ...
    async verifyFace(faceDescriptor) {
        ...
        return users.length > 0 ? user_dto_1.UserDto.fromEntity(users[0]) : null;
    }
};

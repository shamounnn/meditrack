...
const medications_resolver_1 = require("./medications.resolver");
...
exports.MedicationsModule = MedicationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [medications_service_1.MedicationsService, medications_resolver_1.MedicationsResolver, jwt_auth_guard_1.JwtAuthGuard],
